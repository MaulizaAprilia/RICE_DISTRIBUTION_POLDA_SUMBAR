        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="flex items-end">
                <a href="{{ route('admin.polsek.polsekpenjualan') }}"
                    class="w-full px-4 py-2 bg-white border border-green-600 text-green-600 rounded-lg shadow hover:bg-green-50 transition text-center">
                    Reset
                </a>
            </div>
        </form>
